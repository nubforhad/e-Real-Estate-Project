                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <table class="table  table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th class="text-center">
                                                            <input type="checkbox" id="md_checkbox_language"
                                                                class="chk-col-cyan selects " />
                                                            <label for="md_checkbox_language"></label>
                                                        </th>
                                                        <td class="text-left">
                                                            <input type="hidden" name="Language[0]" value="Language">
                                                            Language
                                                        </td>
                                                        @for ($i = 1; $i <= 9; $i++)
                                                            <td class="text-center">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-left">
                                                            <input type="hidden" name="PurchaseRequisition[0]"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-left">
                                                            <input type="hidden" name="PurchaseRQNConfirm[0]"
                                                                value="Purchase RQN Confirm">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-left">
                                                            <input type="hidden" name="PurchaseOrder[0]"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-left">
                                                            <input type="hidden" name="BankCash[0]" value="Bank Cash">
                                                            Bank Cash
                                                        </td>
                                                        @for ($i = 1; $i <= 9; $i++)
                                                            <td class="text-center">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-left">
                                                            <input type="hidden"
                                                                name="InitialIncomeExpenseHeadBalance[0]"
                                                        ...
                                                        @for ($i = 1; $i <= 9; $i++)
                                                            <td class="text-center">
                                                                <div class="switch">
                                                                    <label>
                                                                        <input
                                                                            name="InitialIncomeExpenseHeadBalance[{{ $i }}]"
                                                                            type="checkbox"><span
                                                                            class="lever switch-col-cyan"></span>
                                                                    </label>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-left">
                                                            <input type="hidden" name="ledger[0]" value="Ledger">
                                                            Ledger
                                                        </td>
                                                        @for ($i = 1; $i <= 9; $i++)
                                                            <td class="text-center">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-left">
                                                            <input type="hidden"
                                                                name="statement_of_financial_position[0]"
                                                        ...
                                                        @for ($i = 1; $i <= 9; $i++)
                                                            <td class="text-center">
                                                                <div class="switch">
                                                                    <label>
                                                                        <input
                                                                            name="statement_of_financial_position[{{ $i }}]"
                                                                            type="checkbox"><span
                                                                            class="lever switch-col-cyan"></span>
                                                                    </label>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-left">
                                                            <input type="hidden" name="cash_flow[0]" value="Cash Flow">
                                                            Cash Flow
                                                        </td>
                                                        @for ($i = 1; $i <= 9; $i++)
                                                            <td class="text-center">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-left">
                                                            <input type="hidden" name="notes[0]" value="Notes">
                                                            Notes
                                                        </td>
                                                        @for ($i = 1; $i <= 9; $i++)
                                                            <td class="text-center">
                                                    ...
                                                    <tr>
                                                        <th class="checkbox_custom_style text-center">
                                                            <input name="selectBottom" type="checkbox"
                                                                id="md_checkbox_footer" class="chk-col-cyan topBottom" />
