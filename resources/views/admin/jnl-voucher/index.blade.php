                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <a @if ($trash_show == 0) class="dis-none" @endif
                                ...
                                href="{{ route($ParentRouteName . '.trashed') }}">{{ __('root.common.trash') }}({{ $count_trashed_jv }}
                                )</a>
                                    ...
                                    <table class="table table-hover table-bordered table-sm">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-right width-140">{{ __('root.jnl_voucher.dr') }} (
                                                    <?php echo config('settings.is_code') == 'code' ? config('settings.currency_code') : config('settings.currency_symbol'); ?>)</th>
                                                <th class="text-right width-140">{{ __('root.jnl_voucher.cr') }} (
                                                    <?php echo config('settings.is_code') == 'code' ? config('settings.currency_code') : config('settings.currency_symbol'); ?>) </th>
                                                <th class="text-center width-160">{{ __('root.jnl_voucher.options') }}</th>
                                        ...
                                        <tbody>
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-right width-140">{{ __('root.jnl_voucher.cr') }} (
                                                        <?php echo config('settings.is_code') == 'code' ? config('settings.currency_code') : config('settings.currency_symbol'); ?>) </th>
                                                    <th class="text-center width-160">{{ __('root.jnl_voucher.options') }}
                                                    </th>
