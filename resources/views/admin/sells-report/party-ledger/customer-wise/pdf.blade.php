...
@section('content')
    <div class="mid">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
                <br>
                <h2 class="text-center company-name">{{ config('settings.company_name') }}</h2>
                ...
                <td>
                    ...
                    <table class="table table-striped table-bordered table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Unite Price</td>
                                <td>{{ Helper::convertMoneyFormat($infos['product']->unite_price) }}</td>
                            </tr>
                        </tbody>
                    </table>
                </td>
                    ...
                    <table class="table table-striped table-bordered table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ Helper::convertMoneyFormat($apartMentPrice) }}</td>
                            </tr>
                            <tr>
                                <td>(-) Discount</td>
                                <td>{{ Helper::convertMoneyFormat($discount_or_deduction) }}</td>
                            </tr>
                            <tr class="font-w-b">
                                <td>Total Price</td>
                                <td>{{ Helper::convertMoneyFormat($total_price) }}</td>
                            </tr>
                            <tr>
                                <td>Parking Charge</td>
                                <td>{{ Helper::convertMoneyFormat($infos['product']->car_parking_charge) }}</td>
                            </tr>
                            <tr>
                                <td>Utility Charge</td>
                                <td>{{ Helper::convertMoneyFormat($infos['product']->utility_charge) }}</td>
                            </tr>
                            <tr class="font-w-b">
                                <td>Total Apartment Value</td>
                                <td>{{ Helper::convertMoneyFormat($total_apartment_value) }}</td>
                            </tr>
                            <tr>
                                <td>Additional Work Charge</td>
                                <td>{{ Helper::convertMoneyFormat($infos['product']->additional_work_charge) }}
                                </td>
                            </tr>
                            <tr>
                                <td>Other Charge</td>
                                <td>{{ Helper::convertMoneyFormat($infos['product']->other_charge) }}</td>
                            </tr>
                            <tr>
                                <td>Refund Additional Work Charge</td>
                                <td>{{ Helper::convertMoneyFormat($infos['product']->refund_additional_work_charge) }}
                                </td>
                            </tr>
                            <tr class="font-w-b">
                                <td>Total Apt Value with Additional Charge</td>
                                <td>{{ Helper::convertMoneyFormat($infos['product']->net_sells_price) }}</td>
                            </tr>
                        </tbody>
                    </table>
                    <table class="table table-striped table-bordered table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Sales Date</td>
                                <td>{{ Helper::dateFormat($infos['sells']->sells_date) }}</td>
                            </tr>
                            <tr>
                                <td>Handover Date</td>
                                <td> {{ Helper::dateFormat($infos['branch']->hand_over_date) }} </td>
                            </tr>
                        </tbody>
                    </table>
                </td>
                    ...
                    <table class="table table-striped table-bordered table-sm">
                        ...
                        <tbody>
                            ...
                            @foreach ($infos['schedule_receivable'] as $schedule)
                                ...
                                <tr>
                                    <td>{{ $schedule->term }}</td>
                                    <td>{{ Helper::dateFormat($schedule->schedule_date) }}</td>
                                    <td>{{ Helper::convertMoneyFormat($schedule->payable_amount) }}</td>
                                </tr>
                            @endforeach
                            <tr>
                                <th class="text-right" colspan="2" scope="col">Total</th>
                                <th scope="col">{{ Helper::convertMoneyFormat($total_payable_amount) }}</th>
                            </tr>
                        </tbody>
                    </table>
                </td>
                <td>
                    <table class="table table-striped table-bordered table-sm">
                        <thead>
                            ...
                            <tr>
                                <th class="text-center" scope="col">Term</th>
                                <th data-toggle="tooltip" data-placement="top" title="Date Of Collection"
                                    class="text-center" scope="col">Date</th>
                                <th data-toggle="tooltip" data-placement="top"
                                    title="Receive Amount ( {{ Helper::getCurrencyCode() }} )" class="text-center"
                                    scope="col">Receive Amount</th>
                                <th data-toggle="tooltip" data-placement="top"
                                    title="Adjustment ( {{ Helper::getCurrencyCode() }} )" class="text-center"
                                    scope="col">Adjustment</th>
                                <th data-toggle="tooltip" data-placement="top"
                                    title="Actual Amount ( {{ Helper::getCurrencyCode() }} )" class="text-center"
                                    scope="col">Actual Amount</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($infos['actual_received_info'] as $actual_received)
                                ...
                                <tr>
                                    ...
                                    <td>{{ Helper::dateFormat($actual_received->date_of_collection) }}</td>
                                    <td>{{ Helper::convertMoneyFormat($actual_received->received_amount) }}</td>
                                    <td>{{ Helper::convertMoneyFormat($actual_received->adjustment) }}</td>
                                    <td>{{ Helper::convertMoneyFormat($actual_received->actual_amount) }}</td>
                            ...
                            <tr>
                                ...
                                <th scope="col">{{ Helper::convertMoneyFormat($total_received_amount) }}</th>
                                <th scope="col">{{ Helper::convertMoneyFormat($total_adjustment_amount) }}</th>
                                <th scope="col">{{ Helper::convertMoneyFormat($total_actual_amount) }}</th>
                                <th scope="col" colspan="4"></th>
                            </tr>
                            <tr>
                                <th class="text-right" scope="col" colspan="4">
                                    <h5>Total Recieved Amount :
                                        {{ Helper::convertMoneyFormat($total_actual_amount) }}</h5>
                                </th>
                                <th scope="col" colspan="5">
                                    <h5>Due Amount : {{ Helper::convertMoneyFormat($due_amount) }} </h5>
                                </th>
                            </tr>
                        </tbody>
                    </table>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
            <p class="text-right">Printed Date: {{ now() }}</p>
        </div>
    </div>
