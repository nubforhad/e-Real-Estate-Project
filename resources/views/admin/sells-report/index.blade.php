...
@section('content')
    <section @if ($is_rtl) dir="rtl" @endif class="content">
        <div class="header">
            <h2 class="text-center">{{ __('root.reports.sells_report') }}</h2>
        </div>
            ...
            <div class="row clearfix">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="card">
                        <div class="header bg-cyan">
                            <h2>
                                {{ __('root.reports.customer_wise_party_ledger') }}
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="card">
                        <div class="header bg-cyan">
                            <h2>
                                {{ __('root.reports.customer_party_ledger_summary') }}
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="card">
                        <div class="header bg-cyan">
                            <h2>
                                {{ __('root.reports.seller_name_wise_party_ledger') }}
                                <small>{{ __('root.reports.anything_is_select_show_all') }}</small>
                            </h2>
                        </div>
                        <br>
