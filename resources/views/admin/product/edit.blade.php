                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 field_area">
                                            <div class="form-group form-float">
                                                ...
                                                <div class="form-line">
                                                    <select disabled data-live-search="true" class="form-control show-tick"
                                                        name="branch_id">
                                                        <option value="0">Select Project Name</option>
                                                        @foreach ($branches as $branch)
                                                            <option @if ($branch->id == $item->branch_id) selected @endif
                                                ...
                                                <div class="form-line">
                                                    <select disabled data-live-search="true" class="form-control show-tick"
                                                        ...
                                                        @foreach ($flatTypes as $key => $value)
                                                            <option @if ($key == $item->flat_type) selected @endif
                                                ...
                                                <div class="form-line">
                                                    <select disabled data-live-search="true" class="form-control show-tick"
                                                        ...
                                                        @foreach ($floor_numbers as $key => $value)
                                                            <option @if ($key == $item->floor_number) selected @endif
                                                                value="{{ $key }} ">{{ $value }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group form-float">
                                                <label class="form-label">Flat Size <span class="text-danger">*</span></label>
                                                <div class="form-line">
                                                    <input value="{{ $item->flat_size }}" name="flat_size" type="number"
                                                        class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group form-float">
                                                <label class="form-label">Unite Price  <span class="text-danger">*</span></label>
                                                <div class="form-line">
                                            ...
                                            <div class="form-group form-float">
                                                ...
                                                <div class="form-line">
                                                    <input readonly value="{{ $item->total_flat_price }}"
                                                        name="total_flat_price" type="number" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input value="{{ $item->car_parking_charge }}"
                                                        name="car_parking_charge" type="number" class="form-control">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input value="{{ $item->additional_work_charge }}"
                                                        name="additional_work_charge" type="number" class="form-control">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input value="{{ $item->discount_or_deduction }}"
                                                        name="discount_or_deduction" type="number" class="form-control">
                                            ...
                                            <div class="form-group form-float">
                                                ...
                                                <div class="form-line">
                                                    <input readonly value="{{ $item->net_sells_price }}"
                                                        name="net_sells_price" type="number" class="form-control">
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
            ...
            return {
                ...
                getFields: function() {
                    return {
                        ...
                        get_refund_additional_work_charge: document.querySelector(DOMString
                ...
                getInputsValue: function() {
                    ...
                    return {
                        ...
                        branch_id: Fields.get_branch_id.value == "" ? 0 : parseFloat(Fields.get_branch_id
                            .value),
                        ...
                        flat_size: Fields.get_flat_size.value == "" ? 0 : parseFloat(Fields.get_flat_size
                            .value),
                        unite_price: Fields.get_unite_price.value == "" ? 0 : parseFloat(Fields.get_unite_price
                            .value),
                        total_flat_price: Fields.get_total_flat_price.value == "" ? 0 : parseFloat(Fields
                            .get_total_flat_price.value),

                        car_parking_charge: Fields.get_car_parking_charge.value == "" ? 0 : parseFloat(Fields
                            .get_car_parking_charge.value),
                        utility_charge: Fields.get_utility_charge.value == "" ? 0 : parseFloat(Fields
                            .get_utility_charge.value),
                        additional_work_charge: Fields.get_additional_work_charge.value == "" ? 0 : parseFloat(
                            Fields.get_additional_work_charge.value),
                        other_charge: Fields.get_other_charge.value == "" ? 0 : parseFloat(Fields
                            .get_other_charge.value),
                        discount_or_deduction: Fields.get_discount_or_deduction.value == "" ? 0 : parseFloat(
                            Fields.get_discount_or_deduction.value),
                        refund_additional_work_charge: Fields.get_refund_additional_work_charge.value == "" ?
                            0 : parseFloat(Fields.get_refund_additional_work_charge.value),
                        net_sells_price: Fields.get_net_sells_price.value == "" ? 0 : parseFloat(Fields
                            .get_net_sells_price.value),
        ...
        var MainController = (function(UICnt) {
            ...
            var setUpEventListner = function() {
                ...
                Fields.get_refund_additional_work_charge.addEventListener('keyup',
                    ShowTotalFlatPriceAndNetSellsPrice);
