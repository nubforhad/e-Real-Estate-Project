...
$moduleName = __('root.project.branch_manage');
                                    ...
                                    <table class="table table-hover table-bordered table-sm">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>{{ __('root.project.name') }}</th>
                                                <th>{{ __('root.project.location') }}</th>
                                                <th>{{ __('root.project.description') }}</th>
                                                <th class="width-100 text-center">{{ __('root.project.options') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php $i = 1; ?>
