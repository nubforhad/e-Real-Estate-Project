                                ...
                                <form class="form" id="form_validation" method="post"
                                    ...
                                    <div class="row clearfix">
                                                ...
                                                <div class="form-line">
                                                    <select data-live-search="true" class="form-control show-tick"
                                                        ...
                                                        @foreach ($vendors as $vendor)
                                                            <option @if ($vendor->id == old('vendor_id')) selected @endif
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 field_area">
                                            <div class="form-group ">
                                                <label class="form-label">Media Name <span
                                                    class="text-danger">*</span></label>
                                                <div class="form-line">
                                                    <input placeholder="Media Name " autocomplete="off" value="{{ old('media_name') }}"
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input autocomplete="off" value="{{ old('note') }}" name="note"
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input autocomplete="off" value="{{ old('subject') }}" name="subject"
                                                        type="text" class="form-control">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <textarea class="form-control" name="message_body" id="">{{ old('message_body') }} This is an reference to your discussion had with us today, we are pleased to place an order for supplying Work order for Sylhet Sand at our project under the following terms & conditions.</textarea>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="card">
                                                <div class="header body">
                                                    <h5>Requisition Confirmed ID <span
