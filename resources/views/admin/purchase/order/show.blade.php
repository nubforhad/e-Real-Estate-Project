    ...
    <div class="container">
        ...
        <div class="row mt-2">
            <div class="col-lg-6 col-md-6 col-xl-6 col-sm-6 ">
                <div class="company_logo ">
                    <img width="80px" height="80px" src="{{ asset(config('settings.company_logo')) }}" alt="">
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-xl-6 col-sm-6 ">
                <div
        ...
        <div class="row mb-3">
            <div class="col-lg-10 col-sm-10 col-md-10 col-xl-10">
                <div class="vendor">
                    <span>{{ $items->vendor->name }}</span><br>
                    <span>{{ $items->vendor->mailing_address }}</span>
                </div>
            </div>
            <div class="col-lg-2 col-sm-2 col-md-2 col-xl-2">
                <div class="dob">
                    <p class="text-right">{{ Helper::dateFormat($items->date_of_delevery) }}</p>
                </div>
            </div>
        </div>
        <div class="row ">
        ...
        <div class="row ">
            <div class="col-lg-12 col-sm-12 col-md-12 col-xl-12">
                ...
                <table class="table table-bordered table-sm">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="text-right">Unit Cost ( {{ $transaction->get_currency_code() }} )
                            </th>
                            <th scope="col" class="text-right">Total Price ( {{ $transaction->get_currency_code() }} )
                            </th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th class="text-right">{{ Helper::convertMoneyFormat($items->totalAmount) }}</th>
                            <th></th>
                        </tr>
                    </tbody>
                </table>
                <p>In word: <span class="font-w-b"> {{ Helper::convertNumberToWords($items->totalAmount) }}
                ...
                <br><span><b>3. Date of Delivery: </b> {{ Helper::dateFormat($items->date_of_delevery) }} </span>
                <br><span><b>4. Validity: </b> This order will be valid for 10 (ten) days from the date of issuing this
                    order</span>
                <br><span><b>5. Place of Delivery: </b> {{ $items->branch->name }} | {{ $items->branch->location }}</span>
