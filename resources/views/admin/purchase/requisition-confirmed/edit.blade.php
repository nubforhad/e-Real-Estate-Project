...
$moduleName = __('root.purchase_requisition.purchase_requisition_comfirm');
                                ...
                                <form class="form" id="form_validation" method="post"
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 field_area">
                                            <div class="form-group form-float">
                                                <label class="form-label">Contract Person<span
                                                    class="text-danger"></span></label>
                                                <div class="form-line">
                                                    <input placeholder="Contract Person" autocomplete="off" value="{{ $item->contract_person }}"
                                                        name="contract_person" type="text" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <textarea class="form-control" name="comment" id="">{{ $item->comment }}</textarea>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <textarea class="form-control" name="purpose" id="">{{ $item->purpose }}</textarea>
                                                    ...
                                                    <div class="row dr">
                                                                ...
                                                                <div class="form-line">
                                                                    ...
                                                                    <select data-live-search="true"
                                                                        ...
                                                                        @foreach ($income_expense_heads as $HeadOfAccount)
                                                                            <option
                                                                                @if ($HeadOfAccount->id == $head_id) selected @endif
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 field_area">
                                                            <div class="form-group form-float">
                                                                <div class="form-line">
                                                                    <input
                                                                        value="{{ array_key_exists('0', $items->items) == true ? $items->items[0]->description : ' ' }}"
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 field_area">
                                                            <div class="form-group form-float">
                                                                <div class="form-line">
                                                                    <input
                                                                        value="{{ array_key_exists('0', $items->items) == true ? $items->items[0]->qntity : 0 }}"
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 field_area">
                                                            <div class="form-group form-float">
                                                                <div class="form-line">
                                                                    <input
                                                                        value="{{ array_key_exists('0', $items->items) == true ? $items->items[0]->rate : 0 }}"
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 field_area">
                                                            <div class="form-group form-float">
                                                                <div class="form-line">
                                                                    <input
                                                                        value="{{ array_key_exists('0', $items->items) == true ? $items->items[0]->amount : 0 }}"
                                                    ...
                                                    <div class="row dr">
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 field_area">
                                                            <div class="form-group form-float">
                                                                <div class="form-line">
                                                                    <input
                                                                        value="{{ array_key_exists('1', $items->items) == true ? $items->items[1]->description : '' }}"
                                                                        name="description[]" type="text"
                                                                        class="form-control amount">
                                                                    <label class="form-label">Description </label>
                                                                </div>
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 field_area">
                                                            <div class="form-group form-float">
                                                                <div class="form-line">
                                                                    <input
                                                                        value="{{ array_key_exists('1', $items->items) == true ? $items->items[1]->qntity : 0 }}"
                                                                        name="qntity[]" type="number"
                                                                        class="form-control amount">
                                                                    <label class="form-label">Qntity </label>
                                                                </div>
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 field_area">
                                                            <div class="form-group form-float">
                                                                <div class="form-line">
                                                                    <input
                                                                        value="{{ array_key_exists('1', $items->items) == true ? $items->items[1]->rate : 0 }}"
                                                                        name="rate[]" type="number"
                                                                        class="form-control amount">
                                                                    <label class="form-label">Rate </label>
                                                                </div>
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 field_area">
                                                            <div class="form-group form-float">
                                                                <div class="form-line">
                                                                    <input
                                                                        value="{{ array_key_exists('1', $items->items) == true ? $items->items[1]->amount : 0 }}"
                                                                        readonly name="amount[]" type="number"
                                                                        class="form-control amount">
                                                                    <label class="form-label">Amount </label>
                                                                </div>
                                                    ...
                                                    <div class="row dr">
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 field_area">
                                                            <div class="form-group form-float">
                                                                <div class="form-line">
                                                                    <input
                                                                        value="{{ array_key_exists('2', $items->items) == true ? $items->items[2]->description : '' }}"
                                                                        name="description[]" type="text"
                                                                        class="form-control amount">
                                                                    <label class="form-label">Description </label>
                                                                </div>
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 field_area">
                                                            <div class="form-group form-float">
                                                                <div class="form-line">
                                                                    <input
                                                                        value="{{ array_key_exists('2', $items->items) == true ? $items->items[2]->qntity : 0 }}"
                                                                        name="qntity[]" type="number"
                                                                        class="form-control amount">
                                                                    <label class="form-label">Qntity </label>
                                                                </div>
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 field_area">
                                                            <div class="form-group form-float">
                                                                <div class="form-line">
                                                                    <input
                                                                        value="{{ array_key_exists('2', $items->items) == true ? $items->items[2]->rate : 0 }}"
                                                                        name="rate[]" type="number"
                                                                        class="form-control amount">
                                                                    <label class="form-label">Rate </label>
                                                                </div>
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 field_area">
                                                            <div class="form-group form-float">
                                                                <div class="form-line">
                                                                    <input
                                                                        value="{{ array_key_exists('2', $items->items) == true ? $items->items[2]->amount : 0 }}"
                                                                        readonly name="amount[]" type="number"
                                                                        class="form-control amount">
                                                                    <label class="form-label">Amount </label>
                                                                </div>
                                                    ...
                                                    <div class="row dr">
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 field_area">
                                                            <div class="form-group form-float">
                                                                <div class="form-line">
                                                                    <input
                                                                        value="{{ array_key_exists('3', $items->items) == true ? $items->items[3]->description : '' }}"
                                                                        name="description[]" type="text"
                                                                        class="form-control amount">
                                                                    <label class="form-label">Description </label>
                                                                </div>
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 field_area">
                                                            <div class="form-group form-float">
                                                                <div class="form-line">
                                                                    <input
                                                                        value="{{ array_key_exists('3', $items->items) == true ? $items->items[3]->qntity : 0 }}"
                                                                        name="qntity[]" type="number"
                                                                        class="form-control amount">
                                                                    <label class="form-label">Qntity </label>
                                                                </div>
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 field_area">
                                                            <div class="form-group form-float">
                                                                <div class="form-line">
                                                                    <input
                                                                        value="{{ array_key_exists('3', $items->items) == true ? $items->items[3]->rate : 0 }}"
                                                                        name="rate[]" type="number"
                                                                        class="form-control amount">
                                                                    <label class="form-label">Rate </label>
                                                                </div>
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 field_area">
                                                            <div class="form-group form-float">
                                                                <div class="form-line">
                                                                    <input
                                                                        value="{{ array_key_exists('3', $items->items) == true ? $items->items[3]->amount : 0 }}"
                                                                        readonly name="amount[]" type="number"
                                                                        class="form-control amount">
                                                                    <label class="form-label">Amount </label>
                                                                </div>
                                                    ...
                                                    <div class="row dr">
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 field_area">
                                                            <div class="form-group form-float">
                                                                <div class="form-line">
                                                                    <input
                                                                        value="{{ array_key_exists('4', $items->items) == true ? $items->items[4]->description : '' }}"
                                                                        name="description[]" type="text"
                                                                        class="form-control amount">
                                                                    <label class="form-label">Description </label>
                                                                </div>
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 field_area">
                                                            <div class="form-group form-float">
                                                                <div class="form-line">
                                                                    <input
                                                                        value="{{ array_key_exists('4', $items->items) == true ? $items->items[4]->qntity : 0 }}"
                                                                        name="qntity[]" type="number"
                                                                        class="form-control amount">
                                                                    <label class="form-label">Qntity </label>
                                                                </div>
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 field_area">
                                                            <div class="form-group form-float">
                                                                <div class="form-line">
                                                                    <input
                                                                        value="{{ array_key_exists('4', $items->items) == true ? $items->items[4]->rate : 0 }}"
                                                                        name="rate[]" type="number"
                                                                        class="form-control amount">
                                                                    <label class="form-label">Rate </label>
                                                                </div>
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 field_area">
                                                            <div class="form-group form-float">
                                                                <div class="form-line">
                                                                    <input
                                                                        value="{{ array_key_exists('4', $items->items) == true ? $items->items[4]->amount : 0 }}"
                                                                        readonly name="amount[]" type="number"
                                                                        class="form-control amount">
                                                                    <label class="form-label">Amount </label>
                                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-xl-12 col-sm-12">
                                                ...
                                                <input name="isConfirmed" type="radio" value="1" id="radio_14"
                                                    ...
                                                    @if (!empty($item->requisition_id)) checked @endif>
