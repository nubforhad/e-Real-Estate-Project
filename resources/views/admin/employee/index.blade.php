                    ...
                    <div class="card">
                        <div class="header">
                            <a class="btn btn-xs btn-info waves-effect"
                                href="{{ route($ParentRouteName) }}">{{ __('root.common.all') }} ({{ $total_employees }})
                            </a>
                                    ...
                                    <table class="table table-hover table-bordered table-sm">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>{{ __('root.employee.name') }}</th>
                                                <th>{{ __('root.employee.phone') }}</th>
                                                <th>{{ __('root.employee.email') }}</th>
                                                <th>{{ __('root.employee.position') }}</th>
                                                <th>{{ __('root.employee.department') }}</th>
                                                <th>{{ __('root.employee.address') }}</th>
                                                <th class="width-140 text-center">{{ __('root.employee.options') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php $i = 1; ?>
