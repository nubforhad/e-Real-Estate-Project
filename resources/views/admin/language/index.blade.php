                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <a @if ($trash_show == 0) class="dis-none" @endif
                                ...
                                href="{{ route($ParentRouteName . '.trashed') }}">{{ __('root.common.trash') }}({{ $total_trashed_language }}
                                )</a>
                                    ...
                                    <table class="table table-hover table-bordered table-sm">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center width-160">{{ __('root.language.set_as_default') }}</th>
                                                <th class="text-center width-140">{{ __('root.language.options') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php $i = 1; ?>
