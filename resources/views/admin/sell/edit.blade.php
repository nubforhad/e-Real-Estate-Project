                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <select id="product_id" data-live-search="true"
                                                        class="form-control show-tick" name="product_id">
                                                ...
                                                <div class="form-line">
                                                    <select data-live-search="true" class="form-control show-tick"
                                                        ...
                                                        @foreach (App\Employee::all() as $employee)
                                                            <option @if ($employee->id == $item->employee_id) selected @endif
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line" id="bs_datepicker_container">
                                                    <input autocomplete="off" value="{{ $item->sells_date }}"
                                                        name="sells_date" type="text" class="form-control"
                                                        placeholder=" Sells Date">
                                                </div>
                                            </div>
                                        </div>
                ...
                getInputsValue: function() {
                    ...
                    return {
                        ...
                        branch_id: Fields.get_branch_id.value == "" ? 0 : parseFloat(Fields.get_branch_id
                            .value),
                        customer_id: Fields.get_customer_id.value == "" ? 0 : parseFloat(Fields.get_customer_id
                            .value),
                        employee_id: Fields.get_employee_id.value == "" ? 0 : parseFloat(Fields.get_employee_id
                            .value),
                        product_id: Fields.get_product_id.value == "" ? 0 : parseFloat(Fields.get_product_id
                            .value),
