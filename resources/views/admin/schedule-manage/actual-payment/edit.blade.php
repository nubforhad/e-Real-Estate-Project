        ...
        <div class="container-fluid">
            <div class="block-header pull-left">
                <a class="btn btn-sm btn-info waves-effect"
                    href="{{ route('schedule_manage', $infos['sells_id']) }}">{{ __('root.common.back') }}</a>
            </div>
            <ol class="breadcrumb breadcrumb-col-cyan pull-right">
                ...
                <li><a href="{{ route('schedule_manage', $infos['sells_id']) }}"><i class="material-icons">schedule</i>
                        {{ __('root.schedule.schedule_manage') }}</a></li>
                <li class="active"><i class="material-icons">archive</i> {{ __('root.common.edit') }}</li>
            </ol>
                                ...
                                <form class="form" id="form_validation" method="post"
                                    ...
                                    <div class="row clearfix">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input value="{{ $infos['item']->received_amount }}"
                                                        name="received_amount" type="number" class="form-control">
                                            ...
                                            <div class="form-group form-float">
                                                ...
                                                <div class="form-line">
                                                    <input readonly value="{{ $infos['item']->actual_amount }}"
                                                        name="actual_amount" type="number" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group form-float">
                                                ...
                                                <div class="form-line">
                                                    <input value="{{ $infos['item']->made_of_payment }}"
                                                        name="made_of_payment" type="text" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <textarea class="form-control" name="remark" id="">{{ $infos['item']->remark }}</textarea>
