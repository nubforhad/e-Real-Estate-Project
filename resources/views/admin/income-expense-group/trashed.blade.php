                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <a class="btn btn-xs btn-danger waves-effect"
                                href="{{ route($ParentRouteName. '.trashed') }}">{{ __('root.common.trash') }}({{ $total_trashed_income_expense_group }}
                                )</a>
                                    ...
                                    <table class="table table-hover table-bordered table-sm">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="width-100 text-center">{{ __('root.ledger_group.options') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php $i = 1; ?>
