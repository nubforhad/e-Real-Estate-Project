...
use App\Http\Controllers\ScheduleReceivableController;
...
class ActualReceivedController extends Controller
{
    ...
    {
        $schedule = new ScheduleReceivableController();
        $this->get_terms = $schedule->get_terms();
    }
    /**
    ...
    {
        return view('admin.schedule-manage.actual-payment.create', $this->get_terms)->with('sells_id', $sells_id);
    }
    ...
    public function edit($id, $sells_id)
    {
        ...
        return view('admin.schedule-manage.actual-payment.edit', $this->get_terms)->with('infos', $infos);
    }
