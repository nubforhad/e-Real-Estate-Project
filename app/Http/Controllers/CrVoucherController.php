...
class CrVoucherController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $data['branches'] = Branch::orderBy('updated_at', 'DESC')->get();
        $data['bank_cashes'] = BankCash::orderBy('updated_at', 'DESC')->get();
        $data['income_expense_heads'] = IncomeExpenseHead::orderBy('updated_at', 'DESC')->get();
