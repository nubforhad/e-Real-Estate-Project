...
class ProfileController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('avatar')) {
            $profile_path = public_path() . DIRECTORY_SEPARATOR . 'upload' . DIRECTORY_SEPARATOR . 'avatar' . $user->profile->avatar;
            if (!empty($user->profile->avatar) &&  file_exists($profile_path)) {
